...
TABLES={"campaign_campaigns","campaign_materials","campaign_candidates","campaign_channels","campaign_publications","campaign_results","campaign_metrics","campaign_jobs","campaign_rule_checks","campaign_audit","campaign_settings","campaign_export_tokens"}
SCHEMA="""
