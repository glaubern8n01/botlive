...
O instalador cria `.venv`, instala dependências travadas, compila o dashboard, prepara SQLite/Alembic, gera token criptograficamente aleatório e cria somente diretórios ignorados em `botlive-shop/data/`. O agente e dashboard escutam apenas `127.0.0.1`.
