...
class MigrationTests(unittest.TestCase):
    def test_upgrade_creates_only_shop_live_tables(self):
        ...
        with tempfile.TemporaryDirectory(dir=Path(__file__).parent) as temp:
            ...
            engine.dispose()
            self.assertEqual(tables, {"alembic_version", "shop_live_products", "shop_live_sessions", "shop_live_session_products", "shop_live_audit_events", "shop_live_media_assets", "shop_live_script_blocks", "shop_live_session_materials"})
